...
Minitest.Name = "Mini test"
Minitest.Parent = ScorpMini
Minitest.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
Minitest.BorderColor3 = Color3.fromRGB(0, 0, 0)
Minitest.BorderSizePixel = 0
Minitest.Position = UDim2.new(0.335946858, 0, 0.449172586, 0)
Minitest.Size = UDim2.new(0, 109, 0, 37)
Minitest.Font = Enum.Font.SourceSans
Minitest.Text = "Minimize gui test"
Minitest.TextColor3 = Color3.fromRGB(0, 0, 0)
Minitest.TextSize = 14.000

-- Scripts:

local function RPCRF_fake_script() 
...
coroutine.wrap(RPCRF_fake_script)()
local function OZYW_fake_script() 
	...
	local function updateZoomDistance()
		...
		textLabel.Text = string.format("%.2f", zoomDistance) 
	end
...
coroutine.wrap(OZYW_fake_script)()
local function IHMISO_fake_script() 
	...
	local camera = game.Workspace.CurrentCamera
	local fieldOfViewLabel = script.Parent 
...
coroutine.wrap(IHMISO_fake_script)()
local function DDDFS_fake_script() 
...
coroutine.wrap(DDDFS_fake_script)()
local function RTSGC_fake_script()
...
coroutine.wrap(RTSGC_fake_script)()
local function NSDM_fake_script()
...
coroutine.wrap(NSDM_fake_script)()
local function GPGQJIZ_fake_script()
...
coroutine.wrap(GPGQJIZ_fake_script)()
